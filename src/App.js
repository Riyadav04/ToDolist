...
function App(){
  ...
  <div className="container mt-3">
   ...
   <button onClick={()=>setDefaultStatus("deactive")}disabled={defaultStatus=='deactive'?true:false}className="btn btn-danger">Deactive:{taskList.filter((task)=>{return task.status=='deactive'}).length}</button>
  </div>
  <div className="container mt-3">
